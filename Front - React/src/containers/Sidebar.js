  ...
  return (
    <div>
      <button
        ...
        type="button"
        className="inline-flex items-center p-2 mt-2 ms-3 text-sm rounded-lg md:hidden focus:outline-none focus:ring-2 text-gray-400 hover:bg-gray-700 focus:ring-gray-600"
        onClick={toggleMenu}
      >
                    ...
                    <ul className=" ml-3">
                      ...
                      <li className="flex items-center hover:bg-green-600 text-white rounded-lg p-2">
                        ...
                        >
                          ...
                          Lista de Mantenimientos de Chequeo Preoperacional
                        </a>
                      </li>
                    </ul>
                  )}
