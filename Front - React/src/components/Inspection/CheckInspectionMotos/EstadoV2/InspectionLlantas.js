...
export default function InspectionLlantas({ formData, handleChange }) {
  ...
  const items = [
    { label: "Labrado de Llantas", name: "labrado_llantas" },
    { label: "Presión Inflado", name: "presion_inflado" },
    { label: "Perfil Llantas", name: "perfil_llantas" },
    { label: "Estado Estructural RIN", name: "estado_estructural_rin" }
  ];
