...
export default function InspectionVidriosyEspejos({ formData, handleChange }) {
  const [selectedItem, setSelectedItem] = useState(null);
  const items = [
    {label: "Limpieza", name: "limpieza"},
    {label: "Fijacion", name:"fijacion"},
  ...
  return (
    <div className="flex-1 max-w-4xl mb-4 p-6 bg-white border border-gray-300 rounded-lg shadow-md">
      <h1 className="pb-5 text-xlxl font-bold text-gray-800">Vial</h1>
