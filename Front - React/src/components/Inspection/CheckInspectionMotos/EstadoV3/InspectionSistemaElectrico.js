...
export default function InspectionSistemaElectrico({ formData, handleChange }) {
  const [selectedItem, setSelectedItem] = useState(null);
  const items = [
    {label: "Tablero de instrumentos", name: "tablero_de_instrumentos"},
    {label: "Pito", name:"pito"},
    {label: "Luces direccionales", name: "luces_direccionales"},
